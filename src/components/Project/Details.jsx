...
function Details() {
  ...
  function isSticky() {
    ...
    if (stickyItemParentEl.getBoundingClientRect().top < 0) stickyItemEl.classList.add('is-sticky');
            ...
            <div className="row justify-content-center">
              <div className="col-lg-7">
                <div className="cont md-mb50">
                  ...
                  <p className="mt-15">Now there is more fashion. There is no so-called trends. Now chase
                  ...
                  <div className="mt-30">
                    <h6 className="mb-15 line-height-28">Here choose yourself like that, without any
              ...
              <div className="col-lg-4">
                <div className="info" id="sticky_item" style={{ width: stickyItemWidth }}>
                  <ul>
                    <li className="mb-30">
                      <span className="sub-title"><i className="far fa-calendar-alt mr-10"></i> Date :</span>
                      <p>6, August 2022</p>
                    </li>
                    <li className="mb-30">
                      <span className="sub-title"><i className="fas fa-list-ul mr-10"></i> Categories :</span>
                      <p>Web Design</p>
                    </li>
                    <li className="mb-30">
                      <span className="sub-title"><i className="far fa-user mr-10"></i> Client :</span>
                      <p>FrontendNow</p>
                    </li>
                    <li>
                      <span className="sub-title"><i className="fas fa-globe mr-10"></i> Website :</span>
              ...
              <div className="d-flex align-items-center mt-80 pt-80 bord-thin-top">
                <div className="prev">
                  <h6 className="sub-title">
                    <a href="#"><i className="fas fa-long-arrow-alt-left"></i> Prev Project</a>
                  </h6>
                </div>
                <div className="next ml-auto">
                  <h6 className="sub-title">
                    <a href="#">next Project <i className="fas fa-long-arrow-alt-right"></i></a>
                  </h6>
                </div>
              </div>
            </div>
