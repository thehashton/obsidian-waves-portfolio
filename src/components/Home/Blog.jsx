        ...
        <div className="row">
          <div className="col-12">
            <div className="sec-head bord-thin-bottom pb-20 mb-80">
              <h4 className="sub-title fz-28">Latest News</h4>
            </div>
          </div>
        </div>
          ...
          {data.map((item, index) => (
            <div className="col-lg-4" key={item.id}>
              <div className={`item ${index !== data.length - 1 ? 'md-mb30' : ''}`}>
                ...
                <div className="box">
                  <div className="cont">
                    <span className="date"><i className="fas fa-calendar-alt mr-10 main-color"></i> {item.date}</span>
                    <h5><Link href="/blog-details">{item.title}</Link></h5>
                  </div>
                  <div className="info d-flex align-items-center">
                    <div>
                      <span><i className="fas fa-comments fz-12 mr-5"></i> {item.comments} Comments</span>
                    </div>
                    <div className="ml-auto">
                      <Link href="/blog-details">Read More <svg className="ml-5" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
